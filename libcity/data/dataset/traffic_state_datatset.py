...
class TrafficStateDataset(AbstractDataset):
    ...
    def __init__(self, config):
        ...
        self.parameters_str = \
            ...
            + str(self.add_day_in_week) + '_' + str(self.pad_with_last_sample) + "_" + str(self.hop) + "_" \
            + str(self.num_neighbors) + '_' + str(self.shuffle)
        self.cache_file_name = os.path.join('../../pool_mixer/libcity/cache/dataset_cache/',
                                            'traffic_state_{}.npz'.format(self.parameters_str))
        self.cache_file_folder = '../../pool_mixer/libcity/cache/dataset_cache/'
        ensure_dir(self.cache_file_folder)
        self.data_path = '../../pool_mixer/raw_data/' + self.dataset + '/'
